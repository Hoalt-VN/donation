...
<html xmlns:th="http://www.thymeleaf.org" lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="${pageContext.request.contextPath}/resources/static/admin1/assets/assets/img/ftco-32x32.png">
...
<div class="site-wrap">
    ...
    <header class="site-navbar mt-3">
        <div class="container-fluid">
            ...
            <hr>
            <div>
                <input type="button" value="LOGIN ADMIN"
                    ...
                    <li style="margin-bottom: 20px" class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center ">
                        <div class="job-listing-about d-sm-flex custom-width w-100 justify-content-between mx-4">
                            ...
                            <div class="job-listing-meta custom-width w-20" >
                                <p style="margin-top: 20px" class="btn btn-primary py-2" data-toggle="modal" onclick="window.location.href=`showdetaildonation`; return false;">Quyên góp</p>
